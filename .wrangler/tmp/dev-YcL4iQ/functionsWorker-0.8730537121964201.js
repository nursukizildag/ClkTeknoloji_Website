...
// .wrangler/tmp/bundle-WSFnrB/checked-fetch.js
...
// .wrangler/tmp/bundle-WSFnrB/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-WSFnrB/middleware-loader.entry.ts
...
// .wrangler/tmp/bundle-WSFnrB/middleware-insertion-facade.js
...
// .wrangler/tmp/pages-fUdytZ/functionsWorker-0.8730537121964201.mjs
...
var require_checked_fetch2 = __commonJS2({
  "../.wrangler/tmp/bundle-0SVZBp/checked-fetch.js"() {
    var urls = /* @__PURE__ */ new Set();
    function checkURL(request, init) {
      const url = request instanceof URL ? request : new URL(
        (typeof request === "string" ? new Request(request, init) : request).url
...
var require_strip_cf_connecting_ip_header2 = __commonJS2({
  "../.wrangler/tmp/bundle-0SVZBp/strip-cf-connecting-ip-header.js"() {
    function stripCfConnectingIPHeader(input, init) {
      const request = new Request(input, init);
      request.headers.delete("CF-Connecting-IP");
      return request;
...
var import_strip_cf_connecting_ip_header4 = __toESM2(require_strip_cf_connecting_ip_header2(), 1);
...
var ii = T((Re) => {
  ...
  function Vt(r, e, t) {
    var n;
    Te[r] = (n = /* @__PURE__ */ __name2(class extends t {
      constructor() {
...
var ge = T((Rl, Kt) => {
  ...
  function di(r, e, t, n) {
    if (typeof r.on == "function")
      ...
      r.addEventListener(e, a(/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function i(s) {
...
var Fe = G(() => {
  ...
  mi = Se(ge(), 1);
  a(ha, "isIP");
  yi = /^[^.]+\./, S = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class S2 extends mi.EventEmitter {
    constructor() {
      super(...arguments);
      E(this, "opts", {});
...
var tr = T((Ai) => {
  ...
  var vt = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class vt2 {
    constructor(e, t) {
...
var ts = G(() => {
  "use strict";
  p();
  U = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class U2 {
    constructor() {
...
var ms = G(() => {
  "use strict";
  p();
  Er = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Er {
    constructor(e) {
      E(this, "td");
...
var Bt = T((Ah, Ls) => {
  ...
  }, "add"), Br = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Br {
    constructor(e) {
...
var Ms = T((Ih, ks) => {
  "use strict";
  p();
  var pc = Je(), Fs = /^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/, Lr = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Lr {
    constructor(e, t) {
...
var qs = T((Bh, Os) => {
  "use strict";
  p();
  var { EventEmitter: dc } = ge(), Us = Ms(), Ds = rt(), kr = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class kr extends dc {
    constructor(e, t, n) {
...
var ln = T((_) => {
  ...
  var Kr = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Kr extends Error {
    constructor(e, t, n) {
  ...
  var Mr = Kr;
  _.DatabaseError = Mr;
  var Yr = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Yr {
    constructor(e, t) {
  ...
  var Zr = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Zr {
    constructor(e, t, n, i) {
  ...
  var Dr = Zr;
  _.CopyResponse = Dr;
  var Jr = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Jr {
  ...
  var Or = Jr;
  _.Field = Or;
  var Xr = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Xr {
    constructor(e, t) {
  ...
  var en = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class en {
    constructor(e, t) {
  ...
  var tn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class tn {
    constructor(e, t, n) {
  ...
  var rn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class rn {
    constructor(e, t) {
  ...
  var nn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class nn {
    constructor(e, t, n) {
  ...
  var sn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class sn {
    constructor(e, t, n, i) {
  ...
  var on = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class on {
    constructor(e, t) {
  ...
  var an = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class an {
    constructor(e, t) {
  ...
  var un = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class un {
    constructor(e, t) {
  ...
  var Vr = un;
  _.DataRowMessage = Vr;
  var cn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class cn {
    constructor(e, t) {
...
var Qs = T((Rt) => {
  ...
  Rt.Writer = void 0;
  var hn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class hn {
    constructor(e = 256) {
...
var js = T((kt) => {
  ...
  var Oc = d.allocUnsafe(0), mn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class mn {
    constructor(e = 0) {
...
var Gs = T((Mt) => {
  ...
  Mt.Parser = void 0;
  var k = ln(), qc = js(), wn = 1, Qc = 4, Hs = wn + Qc, $s = d.allocUnsafe(0), bn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class bn {
    constructor(e) {
...
var En = T((Xh, Zs) => {
  "use strict";
  p();
  var Ks = (Fe(), O(wi)), Gc = ge().EventEmitter, { parse: Vc, serialize: Q } = vn(), Ys = Q.flush(), zc = Q.sync(), Kc = Q.end(), Sn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Sn extends Gc {
    constructor(e) {
...
var eo = T((np, Xs) => {
  "use strict";
  p();
  var Yc = ge().EventEmitter, rp = (it(), O(nt)), Zc = rt(), An = ds(), Jc = Cs(), Xc = At(), el = Bt(), Js = qs(), tl = tt(), rl = En(), Cn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Cn extends Yc {
    constructor(e) {
...
var io = T((op, no) => {
  ...
  }, "removeWhere"), Tn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Tn {
    constructor(e, t, n) {
      this.client = e, this.idleListener = t, this.timeoutId = n;
    }
  }, "Tn"), "Tn");
  a(Tn, "IdleItem");
  var _n = Tn, Pn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Pn {
    constructor(e) {
      this.callback = e;
    }
  }, "Pn"), "Pn");
  ...
  var Bn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Bn extends nl {
    constructor(e, t) {
...
var ot = T((vp, at) => {
  ...
  var dl = eo(), yl = tt(), ml = En(), wl = io(), { DatabaseError: gl } = vn(), bl = a(
    (r) => {
      var e;
      return e = /* @__PURE__ */ __name2(class extends wl {
        constructor(n) {
          super(n, r);
        }
      }, "e"), a(e, "BoundPool"), e;
...
a(Ei, "toHex");
p();
var gt = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class gt2 {
  constructor(e, t) {
    this.strings = e;
    this.values = t;
  }
...
a(gt, "SqlTemplate");
var $e = gt;
var Xt = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Xt2 {
  constructor(e) {
    this.sql = e;
  }
}, "Xt2"), "Xt");
...
var as = Se(At());
var us = Se(rt());
var _t = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class _t2 extends Error {
  constructor(t) {
    super(t);
...
__name2(cs, "cs");
a(cs, "neon");
var dr = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class dr2 {
  constructor(e, t, n) {
    this.execute = e;
    this.queryData = t;
    this.opts = n;
...
p();
var wo = Se(ot());
var kn = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class kn2 extends wo.Client {
  constructor(t) {
    super(t);
    this.config = t;
  }
...
__name2(vl, "vl");
a(vl, "promisify");
var Un = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(class Un2 extends go.Pool {
  constructor() {
    super(...arguments);
    E(this, "Client", ut);
...
async function isAuthenticated(request, env) {
  if (request.url.includes("localhost") || request.url.includes("127.0.0.1")) {
    console.log("\u{1F513} Geli\u015Ftirme Modu: G\xFCvenlik kontrol\xFC ge\xE7ici olarak atland\u0131.");
    return true;
  }
  const cookieHeader = request.headers.get("Cookie") || "";
  const match2 = cookieHeader.match(new RegExp(`(?:^|;\\s*)admin_session=([^;]*)`));
...
async function onRequestGet(context) {
  ...
  if (!code)
    return jsonResponse({ error: "Servis kodu gerekli. \xD6rnek: ?code=SRV-XXXXX" }, 400, request);
  try {
    ...
    const result = await sql`
        ...
        `;
    if (result.length === 0)
      return jsonResponse({ error: "Bu servis koduyla kay\u0131t bulunamad\u0131." }, 404, request);
    const statusLabels = {
      alindi: "Cihaz Al\u0131nd\u0131",
      onarimda: "Onar\u0131mda",
...
async function onRequestPut(context) {
  ...
  try {
    ...
    if (data.toggle_featured !== void 0) {
      const result2 = await sql`
                UPDATE products SET is_featured = NOT is_featured, updated_at = NOW()
                WHERE id = ${id} RETURNING *
            `;
      return jsonResponse({ success: true, product: result2[0] }, 200, request);
    }
    const result = await sql`
            UPDATE products SET
...
async function onRequestPost(context) {
  ...
  try {
    if (!env.ADMIN_AUTH)
      throw new Error("ADMIN_AUTH KV namespace not bound");
    ...
    if (!storedCreds && (request.url.includes("localhost") || request.url.includes("127.0.0.1"))) {
      ...
      storedCreds = {
        username: "clk",
        password_hash: "2878ed7042508d29ce8a38a89401f850aeff1ace4646d35f58e9f854c5fd17a9"
        // clk2357
      };
    }
    if (!storedCreds) {
    ...
    return new Response(JSON.stringify({ success: false, message: "Ge\xE7ersiz kullan\u0131c\u0131 ad\u0131 veya \u015Fifre." }), { status: 401, headers });
  } catch (err) {
...
async function onRequestPost2(context) {
  ...
  if (token) {
    try {
      await env.ADMIN_AUTH.delete(`session:${token}`);
    } catch (e) {
    }
  }
...
__name2(generateServiceCode, "generateServiceCode");
...
async function onRequest(context) {
  ...
  if (!hasSession && !isLocal) {
    console.log("\u{1F6AB} Yetkisiz eri\u015Fim denemesi: Giri\u015F sayfas\u0131na y\xF6nlendiriliyor.");
...
@neondatabase/serverless/index.mjs:
  ...
  *)
*/
//# sourceMappingURL=functionsWorker-0.8730537121964201.js.map
